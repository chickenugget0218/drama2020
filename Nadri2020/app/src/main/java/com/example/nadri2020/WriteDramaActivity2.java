...
public class WriteDramaActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_write_drama2);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(WriteDramaActivity2.this, item_num, Toast.LENGTH_SHORT).show(); //9화- 이런식으로 표시됨
            }
        ...
        //RecordDramaActivity 에서 제목, 이미지 uri 얻어옴
        ...
        buttonwrite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(DBhelper == null){
                    DBhelper = new DBhelper(WriteDramaActivity2.this,"TEST",null,DBhelper.DB_VERSION);
                }
